                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <a href="{{ route('roles.create') }}" class="btn btn-info btn-rounded mb-8"><i class="mdi mdi-plus-circle-outline me-1"></i> Tambah Roles </a>
                                                    ...
                                                    <tbody>
                                                      @foreach ($roles as $key => $role)
                                                        <tr>
                                                            ...
                                                            <td class="table-user">{{ $role->name }}</td>
